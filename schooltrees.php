...
$(function() {
    var availableTags = [{value: '0-1161',label: 'Jackfruit'},
    {value: '1-1054',label: 'Maulsari'},{value: '1-1054',label: 'Bulletwood'},{value: '2-1058',label: 'Kadamb'},
    {value: '3-1079',label: 'Jamun'},{value: '4-1036',label: 'Country fig'},
    {value: '5-1041',label: 'Indian Elm'},{value: '5-1041',label: 'Kanju'},
    {value: '6-1045',label: 'Queens flower'}, {value: '6-1045',label: 'Jarul'}, {value: '6-1045',label: 'Pride of India'},
    {value: '7-1063',label: 'Indian Gooseberry'},{value: '7-1063',label: 'Amla'},
    {value: '8-1037',label: 'Bodhi tree'},{value: '8-1037',label: 'Peepal'},
    {value: '9-1090',label: 'Mango'},{value: '10-1040',label: 'Kashmir teak'},{value: '10-1040',label: 'Gamar'},
    {value: '11-1047',label: 'Macaranga'},{value: '11-1047',label: 'Chandada'},
    {value: '12-1008',label: 'Devils tree'},{value: '12-1008',label: 'saptaparni'},
    {value: '13-1048',label: 'Butter tree'},{value: '13-1048',label: 'Mahua'},
    {value: '14-1082',label: 'Teak'}, {value: '14-1082',label: 'Sagun'},
    {value: '16-1012',label: 'Purple bauhinia,'},{value: '16-1012',label: 'Kaniar'}
    ,{value: '17-1034',label: 'Indian coral tree'},{value: '17-1034',label: 'Pangara'},
    {value: '18-1002',label: 'Wood apple'},{value: '18-1002',label: 'Bael'},
    {value: '19-1020',label: 'Indian laburnum'},{value: '19-1020',label: 'Amaltas'},
    {value: '20-1066',label: 'Indian beech'},{value: '20-1066',label: 'Pongam Tree'},
    {value: '21-1074',label: 'True Ashok'},{value: '22-1081',label: 'Tamarind'},{value: '22-1081',label: 'Imli'},
    {value: '23-1030',label: 'Flame tree'},{value: '23-1030',label: 'Gulmohar'},{value: '24-1162',label: 'Rain tree'},
    {value: '25-1015',label: 'Red Silk Cotton'},{value: '25-1015',label: 'Semul'},{value: '0-1161',label: 'Artocarpus heterophyllus'},{value: '1-1054',label: 'Mimusops elengi'},{value: '2-1058',label: 'Neolamarckia cadamba'},
                ...
                if (lat!='')
                 {
                     ...
                     var loccity=$("#city").val();
                      ...
                      if (stateval==''|loccity=='' |locname=='')
                      {
                          alert("Please select the state and other values.");
                          return false;
                      }
                    ...
                    alert("Please enter location data.");
                            return false;
                }
                 var lon = $("#lng").val();
                 var locname=$("#loc_name").val();
          ...
          <ul class="addtreeList">
              <li id="sub1" class="sub1"><a href="#" class="selected" onmouseover="simmid.src='images/Simple-middle-selected.png'" onmouseout="simmid.src='images/Simple-middle.png'"><img src="images/Simple-middle.png" alt=" " name="simmid" width="103" height="73" /></a><span ></span>
                    <ul >
                        ...
                        <li value="1054"><a href="tree_1_2" id="sub_1_2" onClick="setspeciesname('1054','Maulsari','1-1054')">Maulsari</a> <blockquote></blockquote></li>
                        <li value="1058"><a href="tree_1_3" id="sub_1_3" onClick="setspeciesname('1058','Kadamb','2-1058')">Kadamb</a> <blockquote></blockquote></li>
                        <li value="1079"><a href="tree_1_4" id="sub_1_4" onClick="setspeciesname('1079','Jamun','3-1079')">Jamun</a> <blockquote></blockquote></li>
                        <li value="1036"><a href="tree_1_5" id="sub_1_5" onClick="setspeciesname('1036','Country Fig','4-1036')">Country Fig</a> <blockquote></blockquote></li>
                        <li value="1041"><a href="tree_1_6" id="sub_1_6" onClick="setspeciesname('1041','Kanju','5-1041')">Kanju</a> <blockquote></blockquote></li>
                        <li value="1045"><a href="tree_1_7" id="sub_1_7" onClick="setspeciesname('1045','Jarul','6-1045')">Jarul</a> <blockquote></blockquote></li>
                        <li value="1063"><a href="tree_1_8" id="sub_1_8" onClick="setspeciesname('1063','Amla','7-1063')">Amla</a> <blockquote></blockquote></li>
                    </ul>
                </li>
                <li id="sub2" class="sub2"><a href="#" class="selected"onmouseover="simba.src='images/Simple-base-apex-selected.png'" onmouseout="simba.src='images/Simple-base-apex.png'"><img src="images/Simple-base-apex.png" alt=" " name="simba" width="103" height="73" /></a><span></span>
                    <ul >
                        <li value="1037"><a href="tree_2_1"  id="sub_2_1" onClick="setspeciesname('1037','Peepal','8-1037')">Peepal</a> <blockquote></blockquote></li>
                        <li value="1090"><a href="tree_2_2" id="sub_2_2" onClick="setspeciesname('1090','Mango','9-1090')">Mango</a> <blockquote></blockquote></li>
                        <li value="1040"><a href="tree_2_3" id="sub_2_3" onClick="setspeciesname('1040','Gamar','10-1040')">Gamar</a> <blockquote></blockquote></li>
                        <li value="1047"><a href="tree_2_4" id="sub_2_4" onClick="setspeciesname('1047','Chanda','11-1047')">Chanda</a> <blockquote></blockquote></li>
                        <li value="1008"><a href="tree_2_5" id="sub_3_5" onClick="setspeciesname('1008','Saptaparni','12-1008')" >Saptaparni</a> <blockquote></blockquote></li>
                        <li value="1048"><a href="tree_2_6" id="sub_3_1" onClick="setspeciesname('1048','Mahua','13-1048')">Mahua</a> <blockquote></blockquote></li>
                        <li value="1082"><a href="tree_2_7" id="sub_3_1" onClick="setspeciesname('1082','Teak','14-1082')">Teak</a> <blockquote></blockquote></li>
                ...
                <li id="sub3"><a href="#" onmouseover="comp23.src='images/Compound-2or3leaflets-selected.png'" onmouseout="comp23.src='images/Compound-2or3leaflets.png'"><img src="images/Compound-2or3leaflets.png" alt=" " name="comp23" width="103" height="73" /></a><span></span>
                    <ul>
                        <li value="1012"><a href="tree_3_1"  id="sub_3_1" onClick="setspeciesname('1012','Kaniar','16-1012')">Kaniar</a><blockquote></blockquote></li>
                        <li value="1034"><a href="tree_3_2"  id="sub_3_2" onClick="setspeciesname('1034','Pangara','17-1034')">Pangara</a><blockquote></blockquote></li>
                        <li value="1002"><a href="tree_3_3"  id="sub_3_3" onClick="setspeciesname('1002','Woodapple','18-1002')">Woodapple</a><blockquote></blockquote></li>
                ...
                <li id="sub4"> <a href="#" onmouseover="comppinn.src='images/Compound-pinnate-selected.png'" onmouseout="comppinn.src='images/Compound-pinnate.png'"><img src="images/Compound-pinnate.png" alt=" " name="comppinn" width="103" height="73" /></a><span></span>
                    <ul>
                        <li value="1020"><a href="tree_4_1" id="sub_4_1" onClick="setspeciesname('1020','Amaltas','19-1020')" class="selected">Amaltas</a><blockquote></blockquote></li>
                        <li value="1066"><a href="tree_4_2" id="sub_4_2" onClick="setspeciesname('1066','Pongam','20-1066')">Pongam</a><blockquote></blockquote><li>
                        <li value="1074"><a href="tree_4_3" id="sub_4_3" onClick="setspeciesname('1074','Ashoka','21-1074')">Ashoka</a><blockquote></blockquote></li>
                        <li value="1081"><a href="tree_4_4" id="sub_4_4" onClick="setspeciesname('1081','Tamarind','22-1081')">Tamarind</a><blockquote></blockquote></li>
                        ...
                        <li value="1162"><a href="tree_4_6" id="sub_4_6" onClick="setspeciesname('1162','Rain tree','24-1162')">Rain tree</a><blockquote></blockquote></li>
                ...
                <li id="sub5"> <a href="#" onmouseover="comppalm.src='images/Compound-palmate-selected.png'" onmouseout="comppalm.src='images/Compound-palmate.png'"><img src="images/Compound-palmate.png" alt=" " name="comppalm" width="103" height="73" /></a><span></span>
                    <ul>
                        <li value="1015"><a href="tree_5_1" id="sub_5_1" onClick="setspeciesname('1015','Red Silk Cotton','26-1015')" class="selected">Red Silk Cotton</a></li>
