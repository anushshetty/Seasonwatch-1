...
include 'includes/Login.php';
    ...
    $dbc->Connecttodb();
$sql1="SELECT distinct user_groups.group_name,user_groups.group_id, users.educational_district,users.full_name, users.user_name,users.user_id
...
<?
    ...
    <?
				...
				$schoolname = $row['group_name'];
                                ...
                                $coordid= $row['user_id'];
                                $eddistrict = $row['educational_district'];?>
                                <?                             
    ...
    <tr>
                               <td width="5px;"> <?echo $schoolcunt?></td>
                                ...
                                <td><?echo $coordname?></td>
                                <td><?echo $eddistrict?></td>
                                <? }$treecount=0;
