...
<title>SeasonWatch /Individual</title>
...
//	dataString += "&location_type="+$('#location_type').attr('value');
	...
	dataString += "&location_type="+$("#location_type").val();;
	...
	$.ajax({
	type: "POST",
	url: "tracktreesadd.php",
	data: dataString,
	success: function(data){

		var cmpword="success";
        var matchPos1 = data.search(cmpword);
        if(matchPos1 != -1)
        {
...
<body>
                    ...
                    <div class="body_top">
                        <div class="main">
                            ...
                            <!-- Get the list of trees from the database-->
                                    ...
                                    <?echo ucfirst(strtolower(htmlspecialchars($group_trees_row['species_scientific_name'])));?></strong>
                                    </i></h5></div>
                                    </div>
                                     ...
                                     <div class="add_tree_icon">
                                        <ul>
                                           <!-- <li><a href="#dialog_add_obs<?echo $i;?>" name="modal" title="Add/Edit Observation" onclick="window.scrollTo(0, 0);"><img src="images/add_observation.png" alt=""  title="Add/Edit Observation." /></a></li>-->
                                                ...
                                                <li><a href = "javascript:void(0)" onclick = "document.getElementById('lightOne<?echo $i;?>').style.display='block';document.getElementById('fadeOne').style.display='block';window.scrollTo(0, 0);"><img src="images/add_observation.png" alt=""  title="Add/Edit Observation." /></a></li>
                                               <?if ($noofobservationscnt>0){?>
                                                <li><a href="javascript:void(0)" title="Edit Observations" onclick="document.getElementById('lightOne<?echo $i;?>').style.display='none';window.scrollTo(0, 0);edit_obs_load('addobser',<?echo $treeIDAr[$i]?>,<?echo $i?>,0,0)"/><img src="images/pencil.png" alt="no"></img></a></li>
                                                <?}?>
    ...
    <div id="fadeOne" class="black_overlayOne"></div>
        ...
        <!--Add Tree modal starts-->
         <?php include ("generaladdtree.php"); ?>
        <!--Add Tree modal ends-->
        </div>
