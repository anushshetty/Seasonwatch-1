...
<form id="addtree" method="post" action="tracktreesadd.php" onsubmit="AddTreeInfo();">  
    <a href = "javascript:void(0)" onclick = "document.getElementById('lightFour').style.display='none';document.getElementById('fadeOne').style.display='none'"><img src="images/closeone.png" alt="close" id="addtreeclose"/></a>
