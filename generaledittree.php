    ...
    $( "#autotag<?echo $j?>" ).autocomplete({
        ...
        select: function(event, ui) {
          ...
          // var msgaddtree="Is this tree you want to add?"
           //$("#pickmsg<?echo $j?>").text(msgaddtree);
            return false;
            }
    });
});
...
text-align:center;
    ...
    $('.addTreeContainerHolder<?php echo $j?> > div:eq('+index+')').show();//working
         ...
         // This function display all the elements of the select species tab 
         // and hide edit location and edit details tab elements//
        function EnableChoosetreeed<?echo $j?>()
        {
            ...
            document.getElementById('button_area_cancel<?echo $j?>').style.display='none';
            document.getElementById('pickmsg<?echo $j?>').style.display='none'; 
            $("#pickmsg<?echo $j?>").text('');
        }
         // This function display all the elements of the Edit location tab 
         // and hide edit species and edit details tab elements//
        function EnableLocationed<?echo $j?>()
        {
            var selTree = $("#autotag<?echo $j?>").val();
            var seltreespeid=$("#selspecies_id<?echo $j?>").val();
            if ((seltreespeid=='')&& (selTree==''))
            {
        ...
        // This function display all the elements of the edit details tab 
         // and hide edit location and edit species tab elements//
                ...
                if (loclat!='')
                 {
                   ...
                   //copies all values from edit location tab to edit details tab.//
                    document.getElementById('locid<?echo $j?>').value=$("#locationid<?php echo $j?>").val();          
                    document.getElementById('loclat<?echo $j?>').value=loclat;
                    document.getElementById('loclon<?echo $j?>').value=loclong;
                    document.getElementById('loccity<?echo $j?>').value=loccity;
                    ...
                    document.getElementById('button_area_cancel<?echo $j?>').style.display='block';
    ...
    <h3 id="pick<?echo $j?>">Type the Name of the Species you want to add : Eg: Jackfruit <br />
    ...
    <h5 id="pickone<?echo $j?>">Or pick the leaf type from below:</h5>
    ...
    <div id="TBOX<?echo $j?>" class="tree_box">
        ...
        <ul class="addtreeList<?php echo $j?>" id="addtreeList<?php echo $j?>">
         <li id="sub1<?echo $j?>" class="sub1"><a href="#" class="selected" onmouseover="simmid.src='images/Simple-middle-selected.png'" onmouseout="simmid.src='images/Simple-middle.png'" onclick= "changeindex<?echo $j?>(0)"><img src="images/Simple-middle.png" alt=" " name="simmid" width="103" height="73" /></a><span ></span>
                    <ul >
                        <li value="1161" class="selected_2 slected"><a href="#" id="sub_1_1<?echo $j?>" onClick="seltreespecies<?echo $j?>('0-1161','Jackfruit, Artocarpus heterophyllus')">Jackfruit</a> <blockquote></blockquote></li>
                        <li value="1079"><a href="#" id="sub_1_2<?echo $j?>" onClick="seltreespecies<?echo $j?>('1-1079','Jamun, Syzygium cumini')">Jamun</a> <blockquote></blockquote></li>
                        <li value="1045"><a href="#" id="sub_1_3<?echo $j?>" onClick="seltreespecies<?echo $j?>('2-1045','Jarul, Lagerstroemia speciosa')">Jarul</a> <blockquote></blockquote></li>
                        <li value="1063"><a href="#" id="sub_1_4<?echo $j?>" onClick="seltreespecies<?echo $j?>('3-1063','Amla, Phyllanthus emblica')">Amla</a> <blockquote></blockquote></li>
                        <li value="1163"><a href="#" id="sub_1_5<?echo $j?>" onClick="seltreespecies<?echo $j?>('4-1163','Lal champa, Magnolia campbellii')">Lalchampa</a> <blockquote></blockquote></li>
                        <li value="1164"><a href="#" id="sub_1_6<?echo $j?>" onClick="seltreespecies<?echo $j?>('5-1164','Kaphal, Myrica esculenta')">Kaphal</a> <blockquote></blockquote></li>
                        <li value="1071"><a href="#" id="sub_1_7<?echo $j?>" onClick="seltreespecies<?echo $j?>('6-1071','Burans, Rhododendron arboreum')">Burans</a> <blockquote></blockquote></li>
                ...
                <li id="sub2<?echo $j?>" class="sub2"><a href="#" class="selected"onmouseover="simba.src='images/Simple-base-apex-selected.png'" onmouseout="simba.src='images/Simple-base-apex.png'" onclick= "changeindex<?echo $j?>(1)"><img src="images/Simple-base-apex.png" alt=" " name="simba" width="103" height="73" /></a><span></span>
                    <ul >
                        <li value="1165"><a href="#" id="sub_2_1<?echo $j?>" onClick="seltreespecies<?echo $j?>('7-1165','Kainju, Acer sterculiaceum')">Kainju</a> <blockquote></blockquote></li>
                        <li value="1090"><a href="#" id="sub_2_2<?echo $j?>" onClick="seltreespecies<?echo $j?>('8-1090','Aam, Mangifera indica')">Aam</a> <blockquote></blockquote></li>
                        <li value="1035"><a href="#" id="sub_2_3<?echo $j?>" onClick="seltreespecies<?echo $j?>('9-1035','Bargad, Ficus bengalensis')">Bargad</a> <blockquote></blockquote></li>
                        <li value="1065"><a href="#" id="sub_2_4<?echo $j?>" onClick="seltreespecies<?echo $j?>('10-1065','Ashok, Saraca asoca')">Ashok</a> <blockquote></blockquote></li>
                        <li value="1008"><a href="#" id="sub_2_5<?echo $j?>" onClick="seltreespecies<?echo $j?>('11-1008','Saptaparni, Alstonia scholaris')" >Saptaparni</a> <blockquote></blockquote></li>
                        <li value="1166"><a href="#" id="sub_2_6<?echo $j?>" onClick="seltreespecies<?echo $j?>('12-1166','Padam, Prunus cerasoides')">Padam</a> <blockquote></blockquote></li>
                ...
                <li id="sub3<?echo $j?>"><a href="#" onmouseover="comp23.src='images/Compound-2or3leaflets-selected.png'" onmouseout="comp23.src='images/Compound-2or3leaflets.png'" onclick= "changeindex<?echo $j?>(2)"><img src="images/Compound-2or3leaflets.png" alt=" " name="comp23" width="103" height="73" /></a><span></span>
                    <ul>
                        <li value="1012"><a href="#" id="sub_3_1<?echo $j?>" onClick="seltreespecies<?echo $j?>('13-1012','Kaniar, Bauhinia purpurea')">Kaniar</a><blockquote></blockquote></li>
                        <li value="1034"><a href="#"  id="sub_3_2<?echo $j?>" onClick="seltreespecies<?echo $j?>('14-1034','Pangra, Erythrina indica')">Pangra</a><blockquote></blockquote></li>
                        <li value="1017"><a href="#"  id="sub_3_3<?echo $j?>" onClick="seltreespecies<?echo $j?>('15-1017','Dhak, Butea monosperma')">Dhak</a><blockquote></blockquote></li>
                ...
                <li id="sub4<?echo $j?>"> <a href="#" onmouseover="comppinn.src='images/Compound-pinnate-selected.png'" onmouseout="comppinn.src='images/Compound-pinnate.png'" onclick= "changeindex<?echo $j?>(3)"><img src="images/Compound-pinnate.png" alt=" " name="comppinn" width="103" height="73" /></a><span></span>
                    <ul>
                        <li value="1020"><a href="#" id="sub_4_1<?echo $j?>" onClick="seltreespecies<?echo $j?>('16-1020','Amaltas, Cassia fistula')" class="selected">Amaltas</a><blockquote></blockquote></li>
                        <li value="1066"><a href="#" id="sub_4_2<?echo $j?>" onClick="seltreespecies<?echo $j?>('17-1066','Karanj, Pongamia pinnata')">Karanj</a><blockquote></blockquote><li>
                        <li value="1081"><a href="#" id="sub_4_3<?echo $j?>" onClick="seltreespecies<?echo $j?>('18-1081','Imli, Tamarindus indica')">Imli</a><blockquote></blockquote></li>
                        <li value="1167"><a href="#" id="sub_4_4<?echo $j?>" onClick="seltreespecies<?echo $j?>('19-1167','Akhrot, Juglans regia')">Akhrot</a><blockquote></blockquote></li>
                        <li value="1030"><a href="#" id="sub_4_5<?echo $j?>" onClick="seltreespecies<?echo $j?>('20-1030','Gulmohur, Delonix regia')">Gulmohur</a><blockquote></blockquote></li>
                        <li value="1001"><a href="#" id="sub_4_6<?echo $j?>" onClick="seltreespecies<?echo $j?>('21-1001','Babool, Acacia nilotica')">Babool</a><blockquote></blockquote></li>
                        <li value="1011"><a href="#" id="sub_4_7<?echo $j?>" onClick="seltreespecies<?echo $j?>('22-1011','Neem, Azadirachta indica')">Neem</a><blockquote></blockquote></li>
                        <li value="1006"><a href="#" id="sub_4_8<?echo $j?>" onClick="seltreespecies<?echo $j?>('23-1006','Siris, Albizia lebbeck')">Siris</a><blockquote></blockquote></li>
                    </ul>
                </li>
                <li id="sub5<?echo $j?>"> <a href="#" onmouseover="comppalm.src='images/Compound-palmate-selected.png'" onmouseout="comppalm.src='images/Compound-palmate.png'" onclick= "changeindex<?echo $j?>(4)"><img src="images/Compound-palmate.png" alt=" " name="comppalm" width="103" height="73" /></a><span></span>
                    <ul>
                        <li value="1015"><a href="#" id="sub_5_1<?echo $j?>" onClick="seltreespecies<?echo $j?>('24-1015','Semul, Bombax ceiba')" class="selected">Semul</a></li>
          ...
          <?// read xml file and update the all tree info-->
            ...
            <div id="<?echo $Trees->attributes();?><?echo $j?>" class="addTreeContainer<?php echo $j?>">
                <blockquote><img src="<?echo $Trees->Imagename?>" alt="<?echo $Trees->sciencename;?>" title="<?echo $Trees->sciencename;?>"  width="179" height="221" /></blockquote>
                    ...
                    <br>
                    <h3>H: <?echo $Trees->hindiname?>, E: <?echo $Trees->englishname;?>, Ta: <?echo $Trees->tamilname?></h3>
                        <p><?echo $Trees->Info;?></p>
                        <div class="clearBoth"></div>
...
<div id="boxDO<?echo $j?>" style="border:0px solid #000; display:none;">
   <div class="DashBosrdcontainer_add_tree_lightbox">
      <div class="leftBox_ONE">
            ...
            <input name="selspecies_name<?echo $j?>" type="text" value="<?php echo $species_name1;?>" id="selspecies_name<?echo $j?>" title="select the species type from choose tree." DISABLED style="color:#888;background-color:#DADADA;"/></p>
            ...
            <label title="Please select the location">Location Type</label>
             <input name="elocation_type<?echo $j?>" type="text" id="elocation_type<?echo $j?>" value="" disabled title="select the location type from Edit location." DISABLED style="color:#888;background-color:#DADADA;"/>
             </p>        
           <p>
           <p>
    ...
    <p>
       ...
       <p><label title="" style="padding-top:5px;width:110px">Notes about this tree (eg, any peculiarities, perhaps something about its history, etc)</label>&nbsp;
    <textarea class="text_box_textarea" id="eother_notes<?echo $j?>" style="width:190px;height:150px"><?php echo $other_notes1;?></textarea>
    <? if ($_SESSION['usercategory']!='individual'){?>
    </p><p><label title="" style="padding-top:75px;width:110px">Assign to students</label>&nbsp;
    <textarea class="text_box_textarea_one" id="studentname<?echo $j?>" style="width:190px;height:150px" title="eg. John,Bala,Kabir,Seetha"><?php echo $members_assigned1?></textarea><?}?>
    </p>
    </div>
    </div>
    <div class="clearBoth"></div>
...
<div  class="button_area_indiv">
        ...
        <div class="button_area_ok"  id="button_area_ok<?echo $j?>" style="display:none;">
            ...
            <div class="button_area_cancel" id="button_area_cancel<?echo $j?>" style="display:none;"><a href ="javascript:void(0)" onclick = "document.getElementById('lightSix<?php echo $j;?>').style.display='none';document.getElementById('fadeOne').style.display='none';resetall<?php echo $j;?>();" >CANCEL</a></div>
            </div>
