...
//echo $insertdate; 
$chkobser="Select * from user_tree_observations where user_tree_id='$usertreeid' and date='$insertdate'";
$chkobser_rec=mysql_query($chkobser);
...
$result = "INSERT INTO user_tree_observations    
     ...
     VALUES
             ( '$insertdate',  
               ...
               '$usertreeid',
			   '$_SESSION[user_id]',
				'$_POST[leaf_caterpillar]',
				'$_POST[flower_butterfly]',
				'$_POST[flower_bee]',
				'$_POST[fruit_bird]',
				'$_POST[fruit_monkey]'
               )";  
