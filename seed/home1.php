...
function toggle1() {
        ...
        var text1 = document.getElementById("displayTextppt");
...
function toggle2() {
        ...
        var text1 = document.getElementById("displayTexthw");
        if(ele1.style.display == "block") {
        ele1.style.display = "none";
        text1.innerHTML = "Details";
        }
...
<div id="mainHolder">
    ...
    <div id="mainContentHolder" class="home">
            ...
            <div class="leftBlock">
				...
				<?php
                              $qu1="SELECT tree_nickname, species_master.species_id, members_assigned, trees.tree_Id as tid, user_tree_id 
					FROM species_master 
				...
				$members_assigned_names='';
                                $memname=$group_trees_row['members_assigned'];
                                if (!empty($memname))
                                {
...
<div id="dialog3" class="window download">
	...
	<h1>Downloads</h1>
        ...
        <p>Welcome to the Downloads page of the Mathrubhumi SEED-SeasonWatch website. 
        This page contains the 'SeasonWatch Program Kit' for the academic year 2012-2013.</br>
        You can download the files from here to learn more about and to participate in the 
        SeasonWatch program.</p> 
        <ul>
        <li>1.Audio-Visual presentation  (click <a href="Main Menu.exe">here </a>&nbsp;to download. x MB)<a id="displayText" href="javascript:toggle();">&nbsp;Details</a> </li>
        <div id="toggleText" style="display: none"><h2>This zipped file contains the detailed SeasonWatch audio-visual presentation with Malayalam commentary. Copy this file on to your computer and unzip it. 
        If you are using the Windows operating sustem please double click on the 'Main Menu.exe' file and navigate
        through the presentation using the 'Next' and 'Previous' arrow keys at the bottom of the presentation. 
        If you are using Ubuntu or any operating system other than Windows please open the 'Main Menu.swf' file in 
        any internet browser like Firefox or Google chrome and navigate through the presentation using the 'Next' and 'Previous' arrow keys</h2></div>
        
        <li>2.Powerpoint Presentation  (click <a href="downloads/Powerpoint Presentation/JaivavaividhyaSamrakshanam_SeasonWatch_2012.ppt">here</a>&nbsp;to download. x MB)<a id="displayTextppt" href="javascript:toggle1();">&nbsp;Details</a></li>
        <div id="toggleText1" style="display:none;"><h2>This zipped file contains the detailed SeasonWatch audio-visual presentation with Malayalam commentary. Copy this file on to your computer and unzip it. 
        If you are using the Windows operating sustem please double click on the 'Main Menu.exe' file and navigate
        through the presentation using the 'Next' and 'Previous' arrow keys at the bottom of the presentation. 
        If you are using Ubuntu or any operating system other than Windows please open the 'Main Menu.swf' file in 
        any internet browser like Firefox or Google chrome and navigate through the presentation using the 'Next' and 'Previous' arrow keys.</h2></div>
        ...
        <li>3.Handbooks
            <a id="displayTexthw" href="javascript:toggle2();">&nbsp;Details</a></li>
        <div id="toggleText2" style="display: none;">
             <h4>There are three Seed-SeasonWatch Handbooks. The details are given below:</br></h4>
             <h5>1. Handbook in Malayalam  (click <a href="downloads/Handbooks/Handbook_Malayalam.pdf">here</a>&nbsp;to download. x MB)</h5>
        <h3>This is the SeasonWatch handbook in Malayalam. 
            It has ALL THE INSTRUCTIONS AND INFORMATION needed for you to start SeasonWatching today.</h3>
            <h5>2.Tree guide book in English  (click <a href="downloads/Handbooks/TreeGuideBook_English.pdf">&nbsp;here</a>&nbsp;to download. x MB)</h5>
            <h3>This book has a lot of interesting stories about the 25 SeasonWatch trees. 
            This is a companion book to the SeasonWatch Handbook in Malayalam and you can use it to 
            learn more about your trees.</h3>
            <h5> 3.Tree Identification Book  (click <a href="downloads/Handbooks/TreeIdentificationBook.pdf">&nbsp;here</a>&nbsp; to download. x MB)</h5>
            <h3> This handbook has the details about the 25 SeasonWatch trees. You can use this to 
                identify and learn more about the SeasonWatch trees.</h3>
        </div>
