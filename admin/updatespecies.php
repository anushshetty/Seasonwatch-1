...
<body>
Species has been successfully updated. Click Back button to go to the Species Management page.
<p align="left"> 
<input type=reset  value="Back"  class=buttonstyle 
onclick="javascript:window.location='../admin/listspecies.php';">
</p>
</body> 
</html> 
