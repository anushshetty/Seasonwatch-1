...
echo $start_date; ?> to <? echo $end_date ; ?>
 ...
 <div class="popspecies">
	<? 
	$result=mysql_query("select count(user_tree_id) as obs_count from user_tree_observations;");
...
<ul class="chartlist">
      <li>
        <a href="species_users.php?speciesid=<? echo $data2['species_id']; ?>"><? echo $data2['species_primary_common_name']; ?></a>
