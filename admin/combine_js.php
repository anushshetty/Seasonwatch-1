...
define('ARCHIVE_FOLDER', 'js_archive'); // location to store archive, don't add starting or trailing slashes
...
$aFiles = array(
      ...
      'pager/jquery.tablesorter.js',
      'pager/jquery.tablesorter.pager.js',
      'pager/docs.js',
      'pager/chili-1.8b.js',
      'js/jquery/tipsy/src/javascripts/jquery.tipsy.js',
      'js/jquery/jquery.timeago.js'
   );

//$sDocRoot = $_SERVER['DOCUMENT_ROOT']. "/seasonwatch/admin";
