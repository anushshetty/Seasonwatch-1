...
<? if($_SESSION['user_admin']) { ?> 
   ...
   (<a class='help_text' title="<? echo $kml_text; ?>" href='#'> ? </a>)&nbsp;&nbsp;|&nbsp;&nbsp;
 -->

<a title='Download data below as CSV' href='download.php?output=csv<? echo $url_add2; ?>'>CSV</a>&nbsp;(<a class='help_text' title="<? echo $csv_text; ?>" href='#'> ? </a>)
<? } else { echo "&nbsp;&nbsp;|&nbsp;&nbsp;You must be logged in to download data"; }?><br>
<!--
<small>
<b>Note</b>: Numbers and colours on the map indicate the number of unique locations from where sightings have been reported, aggregated over space; locations of the aggregate icons are very approximate. Zoom in to see exact sighting locations
</small>
-->
</div>
...
<!-- Gmap Script commented by Pavanesh by 20Sep 2010
 <div id='text1'>
  ...
  <div id='text2'>
	...
	//if (mysql_num_rows($result) > 0) {
	   ...
	   while ($row = mysql_fetch_array($result)) {
	             print "<tr>";
                        print "<td style='text-align:center'><a href='species_guide.php?speciesid=" . $row{'species_id'} ."'>" . $i . "</a></td>";
