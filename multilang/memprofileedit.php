    ...
    <div class="body_top">
        <div class="main">
            <div class="container">
                ...
                ?>
                <div class="mytree"><?=$Lang->GetString("editprofile_text")?>:&nbsp;<? echo htmlspecialchars($userDetailsObj->fullname); ?></div>
...
<section id="left">
    <div id="userStats" class="clearfix">
        <div class="data">
            ...
            <h2><?=$Lang->GetString("memberinformation_text")?></h2>
            <table id="profiletable">
                 <tr>
                 <td><?=$Lang->GetString("username_text")?></td>
                 <td>:&nbsp;&nbsp;
                     <? $username="";
                     if(empty($userDetailsObj->username)) { $username="-";}
                     else{$username= "$userDetailsObj->username";} ?>
                 <input id="editusername" name="editusername" type="text" value="<? echo htmlspecialchars($username); ?>" autocomplete="off"  class="pronameField" onKeyPress="return lettersonly(this, event)" title="Please enter alphanumeric keys only."/></td>
                </tr>
                <tr >
                <td ><?=$Lang->GetString("fullname_text")?></td>
                ...
                <tr >
                <td ><?=$Lang->GetString("email_text")?></td>
                     <? $email= "";if(empty($userDetailsObj->email)) {$email="-";}else{$email=$userDetailsObj->email;} ?>
                      <td>:&nbsp;&nbsp; <input  id="editemailId" name="editemailId" type="text" value="<? echo htmlspecialchars($email); ?>" autocomplete="off"  class="pronameField"/></td>   
                </tr>
                 <tr >
                 <td><?=$Lang->GetString("address_text")?></td>
            ...
            {?>
                 <td ><?=$Lang->GetString("state_text")?></td>
                 <td>:&nbsp;&nbsp;
                  ...
                  <tr >
                <td ><?=$Lang->GetString("city_text")?></td>
                 ...
                 <tr >
                <td ><?=$Lang->GetString("pincode_text")?></td>
            ...
            <?}else{?>
            <th><?=$Lang->GetString("schoolinformation_text")?></th>
             <tr>
                    <?//get school name
                    ...
                    ?>
                <td><?=$Lang->GetString("schoolname_text")?></td>
                <td> :&nbsp;&nbsp;
                ...
                <tr >
                <td><?=$Lang->GetString("schooladdress_text")?><</td>
                ...
                <tr >
                <td><?=$Lang->GetString("schoolphone_text")?></td>
               ...
               <td>:&nbsp;&nbsp; <input  id="editschoolphone" name="editschoolphone" type="text" value="<? echo htmlspecialchars($schoolph); ?>" autocomplete="off"  class="pronameField" onKeyPress="return lettersonly(this, event)" title="Please enter alphanumeric keys only."/></td>         
                 ...
                 <tr >
                <td><?=$Lang->GetString("schoolstate_text")?></td>
               <td>:&nbsp;&nbsp;
                  <select  title="Select one" id="editschoolstate" name="editschoolstate" class="selectField">
                        <option value="0" <?php if((int)($userDetailsObj->state_id)== '0') { ?> selected="selected"<? } ?> >None</option>
                            <option value="1" <?php if((int)($userDetailsObj->state_id) == '1') { ?> selected="selected"<? } ?> >Andaman and Nicobar Islands</option>
                  ...
                  <tr >
                <td ><?=$Lang->GetString("schoolcity_text")?></td>
                     <? $city="";if(empty($userDetailsObj->city)) {$city= "-";}else{ $city="$userDetailsObj->city";} ?>
                       <td>:&nbsp;&nbsp; <input  id="editschoolcity" name="editschoolcity" type="text" value="<? echo htmlspecialchars($city); ?>" autocomplete="off"  class="pronameField" onKeyPress="return lettersonly(this, event)" title="Please enter alphanumeric keys only."/></td>   
             
                </tr>
                 <tr >
                <td ><?=$Lang->GetString("schoolpincode_text")?> </td>
        ...
        <section id="right">
    <div class="gcontent">
        <div class="head"><h1><?=$Lang->GetString("treelist_text")?></h1></div>
              <div class="boxy">
                <?php
        ...
        ON species_master.species_id = trees.species_id and trees.deleted='0'ORDER BY species_master.species_id ASC");
                ...
                //echo $totaltree;?>
                <h1><?=$Lang->GetString("totaltrees_text")?> - <?echo $totaltree;?></h1>
                 ...
                 <br>
                    <?if ($totaltree >10){
                    	for($i=0;$i<10;$i++){?>
                    	                <span class="treely"><?echo $data[$i];?> </span>
                    	                        <?}?>
                <span style="display: inline;"><a id="displayText" href="javascript:toggle();"><?=$Lang->GetString("alltrees_text")?></a></span>
...
<div class="clearBoth"></div>
  ...
  <p><input name="sub" type="submit" class="register" value="<?=$Lang->GetString("save_but")?>" onclick='return (EditUser());'/>
      <input name="cancel" type="button" class="register" value="<?=$Lang->GetString("cancel_but")?>" onclick="javascript: window.location='memprofile.php'"></p>
</br>
</br>
</br>
