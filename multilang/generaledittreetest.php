...
text-align:center;
    ...
    <input type="text" name="autotag<?echo $j?>" id="autotag<?echo $j?>" value="<?php echo $species_name1;?>" onfocus="if(this.value=='Type the name of the tree you want to add. Eg: Neem')this.value='';"  class="cmnameField"/>
              ...
              <!--  select  id="autotag<?echo $j?>" name="autotag<?echo $j?>"  onChange='seltreespecies<?echo $j?>(this.value)' class="cmnameField">
                            ...
                            <option value="1-1079" >Jamun </option>
                            <option value="2-1045" >Jarul</option>
                            <option value="3-1063" >Amla</option>
                            <option value="4-1163" >Lalchampa</option>
                            <option value="5-1164" >Kaphal</option>
                            <option value="6-1071" >Burans</option>
                            <option value="7-1165" >Kainju</option>
                            <option value="8-1090" >Aam</option>
                            <option value="9-1035" >Bargad</option>
                            <option value="10-1065" >Ashok</option>
                            <option value="11-1008" >Saptrani</option>
                            <option value="12-1166" >Padam</option>
                            <option value="13-1012" >Kaniar</option>
                            <option value="14-1034" >Pangra</option>
                            <option value="15-1017" >Dhak</option>
                            <option value="16-1020" >Amaltas</option>
                            <option value="17-1066" >Karanju</option>
                            <option value="18-1081" >Imli</option>
                            <option value="19-1167" >Akhrot</option>
                            <option value="20-1030" >Gulmohur</option>
                            <option value="21-1001" >Babool</option>
                            <option value="22-1011" >Neem</option>
                            <option value="23-1006" >Siris</option>
                            <option value="24-1015" >Semul</option>
