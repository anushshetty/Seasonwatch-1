...
<body>
    ...
    <div class="body_content_2">
        ...
        <div class="body_top">
            <div class="main">
                <div class="container">
                    ...
                    <div class="mytree"><?=$Lang->GetString("mytree_text")?></div>
                    <div id="lightTwo" class="white_contentTwo">
                        ...
                        <div class="addtree"><a href = "javascript:void(0)" name="openAddTreeModal"><?=$Lang->GetString("butt_add_tree")?> </a></div>
                  </div>
             </div>
        ...
        if ($treeno=="0")
         {?>
               <div class="Notreemsg"><p> <?=$Lang->GetString("welcomemsg_text")?><?=$Lang->GetString("notree_text")?> <br />
			  <?=$Lang->GetString("please_text")?> <a href = "javascript:void(0)" name="openAddTreeModal"><?=$Lang->GetString("butt_add_tree")?></a></p></div>
        <? }
        else
        {
        while ($i<$treeno) 
        {?>
            ...
            $fetchnext=0;
                                    ...
                                    <tr>
                                    <td style="width:92px;height:51px;vertical-align:middle;text-align:center;color:#000080;font-size:18px;"><blockquote style="width:92px;"><?=$Lang->GetString("capleaves_text")?></blockquote></td>
                                    ...
                                    <tr>
                                    <td><blockquote style="width:60px;"><?=$Lang->GetString("fresh_text")?></blockquote></td>
                                    </tr>
                                    <tr>
                                    <td><blockquote style="width:60px;"><?=$Lang->GetString("mature_text")?></blockquote></td>
                                    </tr>
                                    </table>
                                    </td>
                                     <!-- Leaves-->
                            ...
                            <table width="673" border="0" cellspacing="0" cellpadding="0" style="border-bottom:1px solid #d1d1d1;">
                            <tr>
                            <td style="width:92px;height:51px;vertical-align:middle;text-align:center;color:#000080;font-size:18px;"><blockquote style="width:92px;"><?=$Lang->GetString("capflowers_text")?></blockquote></td>
                            <td style="height:51px;vertical-align:middle;padding:0px 15px; font-size:15px;  text-align:right;">
                            <table width="51%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                            <td><blockquote style="width:60px;"><?=$Lang->GetString("bud_text")?></blockquote></td>
                            </tr>
                            <tr>
                            <td><blockquote style="width:60px;"><?=$Lang->GetString("open_text")?></blockquote></td>
                            </tr>
                            </table>
                            </td>
                            ...
                            <table width="673" border="0" cellspacing="0" cellpadding="0" style="border-bottom:1px solid #d1d1d1;">
                            <tr>
                            <td style="width:92px;height:51px;vertical-align:middle;text-align:center;color:#000080;font-size:18px;"><blockquote style="width:92px;"><?=$Lang->GetString("capfruit_text")?></blockquote></td>
                            <td style="height:51px;vertical-align:middle;padding:0px 15px; font-size:15px;  text-align:right;">
                            <table width="51%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                            <td><blockquote style="width:60px;"><?=$Lang->GetString("unripe_text")?></blockquote></td>
                            </tr>
                            <tr>
                            <td><blockquote style="width:60px;"><?=$Lang->GetString("ripe_text")?></blockquote></td>
                            </tr>
                            </table>
                            </td>
                            <?for ($k =0; $k <8; $k++) 
                            ...
                            <table width="673" border="0" cellspacing="0" cellpadding="0" >
                            <tr>
                            <td style="height:51px;vertical-align:middle;text-align:center;color:#666666;font-size:14px;"><blockquote style="width:92px;"><?=$Lang->GetString("weekstart_text")?></blockquote></td>
                            <td style="height:51px;vertical-align:middle;padding:0px 15px;"><blockquote style="width:60px;">&nbsp;</blockquote></td>
                               ...
                               ?>
								...
								<?}?>   
                                        ...
                                        <?}else{?>
                                        <div class="link"> <?=$Lang->GetString("noobservation_text")?> <?=$Lang->GetString("please_text")?> <a href = "javascript:void(0)" onclick = "document.getElementById('lightOne<?echo $i;?>').style.display='block';document.getElementById('fadeOne').style.display='block';window.scrollTo(0, 0);"><?=$Lang->GetString("addobservation_text")?>.</a></div>
                                        <?}?>
