 ...
 <!-- <form name="add_obs" id="add_obs" method="POST" action="updateobservation.php" onSubmit="return Add_obs_submit(<?echo $i;?>);">-->
    <div class="addDashBosrdcontainer">
		...
		<div class="addcalendar">
        		 <p>Observed On</p>
			 <blockquote><input type="text"  name ="obdate<?echo $i;?>" id="obdate<?echo $i;?>" onchange="checkdateexists(<?php echo $i;?>,<?php echo $treeInfo[6];?>)" readonly="true"/></blockquote>
...
<div class="addadditionalBox">
  ...
  <div class="addtestbutton_area">
     ...
     if ($i==0)
      {?>
      <div class="right_button"><a href="#" onclick = "document.getElementById('lightOne<?echo $i;?>').style.display='none';document.getElementById('lightOne<?echo $i+1;?>').style.display='block';document.getElementById('fadeOne').style.display='block'" title="Next Tree">NEXT</a></div>
        <?         
      }
       else if($i==($_SESSION['NoTrees']-1))
      { //show only previous button?>
      <div class="left_button"><a href="#" onclick = "document.getElementById('lightOne<?echo $i;?>').style.display='none';document.getElementById('lightOne<?echo $lastcount-1?>').style.display='block';document.getElementById('fadeOne').style.display='block'" title="">PREVIOUS</a></div>
      <?}
      else
      {//show both next & previous button ?>
          <div class="left_button"><a href="#" onclick = "document.getElementById('lightOne<?echo $i;?>').style.display='none';document.getElementById('lightOne<?echo $i+1;?>').style.display='block';document.getElementById('fadeOne').style.display='block'" title="<?echo $i+1;?>">PREVIOUS</a></div>
          <div class="right_button"><a href="#" onclick = "document.getElementById('lightOne<?echo $i;?>').style.display='none';document.getElementById('lightOne<?echo $i-1;?>').style.display='block';document.getElementById('fadeOne').style.display='block'" title="<?echo $i-1;?>">NEXT</a></div>
     <?}?>
      <div class="right_side_button">
          ...
          <!-- div class="button_area_ok" type="submit">OK</a></div-->
           <input name="OBS" id="OBS" type="submit" value="OK" class="addbutton_area_ok" style="cursor:pointer;"  />    
           	<div class="button_area_cancel"><a onclick="document.getElementById('lightOne<?echo $i;?>').style.display='none';document.getElementById('fadeOne').style.display='none'" href="javascript:void(0)">CANCEL</a></div>
	</div>
   </div>
  </form>      