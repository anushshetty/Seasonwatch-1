            ...
            <div class="top_right">
              ...
              <div class="menu"> <!--  start menu  -->
               <ul>
                    ...
                    <?}?>
                    <?php if (isset($_SESSION['log_status']) == 'Y'){?>
                    <? //to restrict the full name not longer than 7 characters.
                      $pattern="..";
                      $displayname="";
                      if  (strlen($_SESSION['fullname']) > 7) $displayname=  rtrim(substr($_SESSION['fullname'], 0, 7)) . $pattern; 
                      else $displayname= $_SESSION['fullname'];?>
                    <div class="clear"></div>
                     <div class="container">
                        <div class="dashboardSection">
                                ...
                                <li><a href="logout.php" title="Logout"><?=$Lang->GetString("logout_but")?></a></li>
                                </ul>  </p>
                            </div>
                        </div>
                        <?php      
