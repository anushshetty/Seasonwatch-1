...
<div class="footer_SECTION">
    <div class="main">
        <div class="container">
            <div class="footerNAV">
                <ul>
                    <li><a class="select" href="index.php"><?=$Lang->GetString("home_menu")?></a></li>
                    <li><a href="details.php"><?=$Lang->GetString("details_menu")?> </a></li>
		    <li><a href="javascript:void(0)" onclick = "document.getElementById('lightdownload').style.display='block';document.getElementById('fade').style.display='block';window.scrollTo(0, 0);"><?=$Lang->GetString("download_menu")?>  </a></li>
                      <li><a href="javascript:void(0)" onclick = "document.getElementById('lightcontactus').style.display='block';document.getElementById('fade').style.display='block';window.scrollTo(0, 0);"><?=$Lang->GetString("contact_menu")?>  </a></li>
					  <? if (isset($_SESSION['log_status']) == 'Y') {?>
					  <li><a href = "#">Register</a></li>
                 <?}else{?>
                    <li><a href = "javascript:void(0)" onclick = "document.getElementById('lightReg').style.display='block';document.getElementById('fade').style.display='block';window.scrollTo(0, 0);"><?=$Lang->GetString("register_menu")?></a></li>
			     <?}?>
                </ul>
            </div>
