...
<div id="boxDO" style="border:0px solid #000; display:none;">
   <div class="DashBosrdcontainer_add_tree_lightbox">
      <div class="leftBox_ONE">
            ...
            <input name="" type="text" value="" id="selspecies_name" readonly="readonly" title="select the species type from choose tree."/></p>
            <input type="hidden" id="selspecies_id" name="selspecies_id" value="" /> 
            <p><label>Latitude</label><input type=text id="loclat"  name="loclat" value="" DISABLED style="background-color:#fff;"/></p>
