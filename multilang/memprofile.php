        ...
        <div class="main">
            <div class="container">
               ...
               $userDetailsObj = unserialize ( $_SESSION['encoded_userobject'] );?>
                <div class="mytree"><?=$Lang->GetString("viewprofile_text")?> :&nbsp;<? echo htmlspecialchars($userDetailsObj->fullname); ?></div>
...
<form  name="edituser" action="memprofileedit.php"  method="post" > <!-- farheen -->
  <br>
    <span class="msg" ><?php echo $Lang->GetString("profileeditresult_text")?></span>
    <section id="left">
        ...
        <div class="data">
            ...
            <th ><?=$Lang->GetString("schoolinformation_text")?></th>
             <tr>
                ...
                <tr >
                <td class="alt"><?=$Lang->GetString("schooladdress_text")?></td>
                <td> :&nbsp;&nbsp;
...
<div class="button_area_ok"><p><input name="sub" type="submit" class="register" value="<?=$Lang->GetString("edit_but")?>" onClick=/></p></div>
<div class="button_area_ok"><p> <input name="changepasswd" type="button" class="changepasswd" value="<?=$Lang->GetString("editpwd_but")?>" onclick="javascript: window.location='memprofilepasswdchange.php'"> </div>
</section>
        <section id="right">
    <div class="gcontent">
