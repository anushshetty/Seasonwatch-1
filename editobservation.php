...
<a href = "javascript:void(0)" onclick = "closeeditob();"><img src="images/closeone.png" alt="close" align="right"/></a>
...
?>
    ...
    <div class="button_area">
        <div class="right_side_button">
            ...
            <div class="button_area_cancel"><a href ="javascript:void(0)" onclick ="closeeditob();">CANCEL</a></div>
        </div>
